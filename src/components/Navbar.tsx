    ...
    <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100">
      <div className="w-full pl-1 pr-2 lg:pl-2 lg:pr-4 py-4 flex justify-between items-center gap-2">
        <Link href={isEn ? "/en/about" : "/chi-siamo"} className="flex justify-start group shrink-0 ml-0 pl-0" aria-label="Yacht Advisor - Chi siamo">
          <img src="/yacht-advisor/rosa-venti.svg" alt="Rosa dei venti" className="w-12 h-12 md:w-15 md:h-15 opacity-95 group-hover:rotate-180 transition-transform duration-700 shrink-0 drop-shadow-[0_2px_8px_rgba(15,23,42,0.14)] [filter:drop-shadow(0_1px_3px_rgba(212,175,55,0.18))] ml-0 pl-0" />
        </Link>
