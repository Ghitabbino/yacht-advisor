...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100">
      <div className="w-full pl-2 pr-4 lg:pl-4 lg:pr-6 py-4 flex justify-end items-center gap-6">
        <Link href={isEn ? "/en/about" : "/chi-siamo"} className="flex items-center gap-3 group shrink-0 ml-auto" aria-label="Yacht Advisor - Chi siamo">
          ...
          <span className="flex flex-col items-start leading-none">
            <span className="font-luxury text-[22px] md:text-[26px] font-black tracking-[0.36em] text-[#020817] leading-none">YACHT<span className="text-[#D4AF37]"> ADVISOR</span></span>
            <span className="text-[10px] md:text-[11px] uppercase tracking-[0.40em] text-[#0F172A] mt-1 font-semibold leading-none whitespace-nowrap">
