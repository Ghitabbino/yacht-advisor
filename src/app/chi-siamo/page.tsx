              ...
              <div className="flex-1">
                ...
                <div className="mt-5 grid sm:grid-cols-2 gap-4 text-[13px]">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 font-light">IT madrelingua • EN professionale • PT fluente • ES intermedio — comprensione e conversazione operativa</p>
                  </div>
                </div>
              ...
              <div className="flex-1">
                ...
                <div className="mt-5 grid sm:grid-cols-2 gap-4 text-[13px]">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 font-light">IT madrelingua • EN ottimo • FR fluente — madre francese</p>
