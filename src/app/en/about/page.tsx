              ...
              <div className="flex-1">
                ...
                <div className="mt-5 grid sm:grid-cols-2 gap-4 text-[13px]">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 font-light">IT native • EN professional • PT fluent • ES intermediate</p>
                  </div>
                </div>
              ...
              <div className="flex-1">
                ...
                <div className="mt-5 grid sm:grid-cols-2 gap-4 text-[13px]">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 font-light">IT native • EN good • FR fluent</p>
