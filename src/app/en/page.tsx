        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-10 md:gap-8">
            <div className="text-center">
              ...
              <p className="text-sm leading-relaxed font-light text-gray-600">We assess your needs through <strong className="font-normal text-[#0F172A]">dedicated interviews</strong> — active listening and reconstruction of your cruising programme — to define objective, shared criteria. On that basis we <strong className="font-normal text-[#0F172A]">submit a clear proposal</strong> outlining scope, steps, timing and fee. <strong className="font-normal text-[#0F172A]">Only if you agree do you grant us a mandate.</strong> No commitment beforehand, no solution proposed before we understand what serene, surprise-free cruising truly means to you.</p>
            </div>
      ...
      <section id="contact" className="py-24 md:py-32 bg-white scroll-mt-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="mt-8 text-center text-[11px] leading-relaxed text-gray-400 font-light">
            Prefer to write directly? <a href="mailto:yachtadvisor@mail.com" className="text-[#0F172A] underline decoration-[#D4AF37] underline-offset-4 hover:text-[#D4AF37] transition">yachtadvisor@mail.com</a> — confidential correspondence.
          </p>
        </div>
      </section>
    </>
